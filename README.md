# claudiomendonca.com — Project Directions

This folder is a **brief package** for a design/build agent. No code yet — these
docs are the source of truth for what to build and how it should look.

Read in order:

1. **`01-brief.md`** — What this site is, who it's for, scope, products to feature.
2. **`02-design-system-motto.md`** — The visual language. Full Motto® style
   reference (colors, type, spacing, components, do's & don'ts, CSS variables).
...
shadows or chromatic UI color.

Products to feature (launch set): `cutthecrap`, `edge`, `squoosh.ccmdesign`,
`varro`.
